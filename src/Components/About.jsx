  ...
  return (
    ...
    className="w-full h-screen bg-gradient-to-b from-gray-800 to-black text-white">
      ...
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <br/>
        24 Years Old from Shegaon( Maharashtra ). I currently live in Shegaon - Completed graduation as an Computer Science Engineer from P.R.Pote Patil College of Engineering and Management, Amravati. Currently working as a freelancer . I am professionally trained as a Data Analysis and Mern Stack Developer. Also trying to keep hand-on programming from past 4 years and practicing Web Development from past 2 years and practicing Data Analysis from past 1 year.
        </p>
        <br />
        <p className="text-xl">
